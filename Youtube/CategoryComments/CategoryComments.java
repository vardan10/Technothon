...
public class CategoryComments {
    ...
    public static class Map1 extends Mapper<LongWritable, Text, Text, FloatWritable> {
       ...
       public void map(LongWritable key, Text value, Context context ) throws IOException, InterruptedException {
          ...
          if(str.length > 9){
                ...
                if(str[10].matches("\\d+.+")){ //this regular expression specifies that the string should contain only floating values
                float f=Float.parseFloat(str[10]); //typecasting string to float
                rating.set(f);
                }
          }
    ...
    public static void main(String[] args) throws Exception {
      ...
      Configuration conf = new Configuration();
       ...
       job.setJarByClass(CategoryComments.class);
       ...
       FileWriter writer = new FileWriter(new File("mapreduceET1.txt"));
